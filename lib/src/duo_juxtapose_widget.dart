...
/// A widget for comparing two stacked widgets twice by dragging a slider thumb to
/// reveal either sides of the sliders.
///
/// Sliding direction can be [Axis.horizontal] or [Axis.vertical].
class DuoJuxtapose extends StatefulWidget {
  ...
  /// The primary foreground widget is displayed in front of the [primaryBackgroundWidget].
  final Widget primaryForegroundWidget;

  /// The primary background widget is displayed behind the [primaryForegroundWidget].
  final Widget primaryBackgroundWidget;

  /// The secondary foreground widget is displayed in front of the [secondaryBackgroundWidget] if one is defined otherwise its the [primaryBackgroundWidget].
  final Widget? secondaryForegroundWidget;

  /// The secondary background widget is displayed behind the [secondaryForegroundWidget] if one is defined otherwise its the [primaryForegroundWidget].
  final Widget? secondaryBackgroundWidget;
  ...
  DuoJuxtapose({
    Key? key,
    required this.primaryBackgroundWidget,
    required this.primaryForegroundWidget,
    this.secondaryBackgroundWidget = null,
    this.secondaryForegroundWidget = null,
  ...
  @override
  _DuoJuxtaposeState createState() => _DuoJuxtaposeState();
}

class _DuoJuxtaposeState extends State<DuoJuxtapose> {
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              if (!_initialised) {
                ...
                if (_isHorizontal) {
                  _position = Offset((_width / 2 * widget.initialPosition), 0);
                } else {
                  _position = Offset(0, (_height / 2 * widget.initialPosition));
                }
              }
              return Center(
                  child: Row(
